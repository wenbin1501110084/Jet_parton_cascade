...
clin-9/2023 for jet vn studies, skip HIJSET & open parton shower file:
c      CALL HIJSET(EFRM, FRAME, PROJ, TARG, IAP, IZP, IAT, IZT)
      OPEN (97, FILE = 'parton_info.dat', STATUS = 'UNKNOWN')
      READ (97, *)
...
clin-9/2023 for jet vn, skip hadron output for now:
c       CALL ARTOUT(NEVNT)
