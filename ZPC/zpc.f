...
clin-6/2009
clin-9/2023 for jet vn, no need to write parton-initial-afterPropagation:
c        if(isoft.eq.1.and.(ioscar.eq.2.or.ioscar.eq.3))
c     1       write(92,*) iaevt,miss,mul
        if(isoft.eq.1.and.(ioscar.eq.2))
