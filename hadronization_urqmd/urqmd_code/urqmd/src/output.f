...
c
      ...
      integer iiunit,isunit, id, pdgid, idd
...
c now write particle-output
 ...
 878  format(1i6,5e16.8)
 
c write spectators id = pdgid(ityp(i), iso3(i))
        if(CTOption(28).eq.2)then
          do 191 i=1,nspec
            idd = pdgid(ityp(i), iso3(i))
            write(iou(13),878)idd, fmass(i), p0s(i),
     @        pxs(i),pys(i),pzs(i)
 191      continue
        endif
